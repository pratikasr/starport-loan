...
export const protobufPackage = 'pratikasr.starportloan.starportloan';
...
export class QueryClientImpl {
    ...
    Loan(request) {
        ...
        const promise = this.rpc.request('pratikasr.starportloan.starportloan.Query', 'Loan', data);
        return promise.then((data) => QueryGetLoanResponse.decode(new Reader(data)));
    }
    LoanAll(request) {
        const data = QueryAllLoanRequest.encode(request).finish();
        const promise = this.rpc.request('pratikasr.starportloan.starportloan.Query', 'LoanAll', data);
